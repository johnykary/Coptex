    ...
    <div class="col-lg-10 col-lg-offset-1">
        ...
        <div class="tab-content">
            ...
            <div id="Artciles" class="tab-pane fade in active">
                <h3 style="color:white">Add Content</h3>
                    <form name="addHomeContent" id="addHomeContent" method="post">
                        ...
                        <div id="success"></div>                    
                        <button type="submit" class="btn btn-primary" id="uploadBtn">Add Content</button>
                    </form>
